...
class Farsi extends StatefulWidget {
  Farsi(this.textfanameh,this.textfakhotbe,this.textfahekmat,this.id,this.fav,);
  String textfanameh,textfahekmat,textfakhotbe,id,fav;
  @override
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Directionality(
                ...
                child: Text(widget.textfanameh+widget.textfahekmat+widget.textfakhotbe,style: TextStyle(fontFamily:'SocialSites',fontSize: textSize,fontWeight: FontWeight.w600))),
          ),
        ),
      ),
