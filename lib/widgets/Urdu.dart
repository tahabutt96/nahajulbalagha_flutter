...
class Urdu extends StatefulWidget {
  Urdu(this.textfa,this.id,this.fav);
  String textfa,id,fav;
  @override
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Directionality(
                ...
                child: SizedBox(
                    child: Text(widget.textfa,style: TextStyle(fontFamily: 'SocialSites',fontSize: textSize,fontWeight: FontWeight.w600)))),
          ),
        ),
      ),
