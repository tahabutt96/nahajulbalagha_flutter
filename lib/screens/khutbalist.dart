...
import 'package:nahjul_balagha/screens/khutbadetails.dart';
import 'package:sqflite/sqflite.dart';

class khutbalist extends StatefulWidget {
  @override
  _khutbalistState createState() => _khutbalistState();
}

class _khutbalistState extends State<khutbalist> {
  ...
  void initState() {
    ...
    super.initState();
    dbconnect.getkhutbaList().then((rows) {
      setState(() {
        rows.forEach((row) {
  ...
  //              crossAxisAlignment: CrossAxisAlignment.center,
                children: <Widget>[
                  ...
                  Material(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => khutbadetails(categories[position].fav.toString(),categories[position].id.toString(),categories[position].atitle,categories[position].textar,categories[position].textfa,categories[position].textfakhotbe,categories[position].textfanameh,categories[position].textfahekmat)));
                      },
                      child: Container(
