...
class favArabic extends StatefulWidget {
  @override
  _favArabicState createState() => _favArabicState();
}

class _favArabicState extends State<favArabic> {
  ...
  void initState() {
    ...
    super.initState();
    dbconnect.getfavMaktoobList().then((rows) {
      setState(() {
        rows.forEach((row) {
