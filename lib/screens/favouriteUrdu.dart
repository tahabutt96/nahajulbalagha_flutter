...
class favUrdu extends StatefulWidget {
  @override
  _favUrduState createState() => _favUrduState();
}

class _favUrduState extends State<favUrdu> {
  ...
  void initState() {
    ...
    super.initState();
    dbconnect.getfavHitkmatList().then((rows) {
      setState(() {
        rows.forEach((row) {
